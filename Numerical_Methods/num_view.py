...
class First_View():
    def __init__(self, Master):
        ...
        self.omega=tk.StringVar(self.Frame)
        ...
        self.omega_label=ttk.Label(self.Mesh, text=u"\u03a9",style="BW.TLabel").pack()
        self.input_omega=ttk.Entry(self.Mesh, textvariable=self.omega).pack()
