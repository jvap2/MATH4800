...
import d_norms
import time
from d_norms import Left_True_Solution, Right_True_Solution,Left_Ex_1,Left_Ex_2,Left_Ex_3
...
class Controller():
    ...
    def make_mesh(self, event):
        ...
        plt.grid()
        plt.show()
        norm_inf_ss=d_norms.CompTrad_Err_ThirdOrder(x_np,u_cub)
        norm_inf_ss_lin=d_norms.Norm_SS(x_np,u_lin, 'linear')
