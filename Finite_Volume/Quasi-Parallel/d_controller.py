...
class Controller():
    ...
    def make_mesh(self, event):
        ...
        plt.grid()
        plt.show()
        norm_2_ss,norm_inf_ss=d_norms.Norm_SS(x_np,u_cub)[0],d_norms.Norm_SS(x_np,u_cub)[1]
        norm_2_ss_lin, norm_inf_ss_lin=d_norms.Norm_SS(x_np,u_lin)[0],d_norms.Norm_SS(x_np,u_lin)[1]
        ...
        print("-----------------------------------------------------------------------------------------------------------")
        print(f"Steady State L\u2082: {norm_2_ss_lin}\nSteady State L\u221e:{norm_inf_ss_lin}")
        # print("-----------------------------------------------------------------------------------------------------------")
